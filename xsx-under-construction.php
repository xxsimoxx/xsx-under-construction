...
class UnderConstruction {
	...
	public function render_menu () {
		...
		echo '<form action="'.add_query_arg(['action' => 'url'], admin_url('admin.php?page='.self::SLUG.'')).'" method="POST">'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
		...
		echo '<form action="'.add_query_arg(['action' => 'new'], admin_url('admin.php?page='.self::SLUG.'')).'" method="POST">'; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
